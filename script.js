...
$(document).ready(function () {
    ...
    function generateTable() {
        ...
        console.log("Generating table with values:", startMultiplier, endMultiplier, startMultiplicand, endMultiplicand);
        ...
        if ($(`#${tableId}`).length === 0) {
            // Build the HTML for the multiplication table
            ...
            // Add the new tab to the tabs element
            ...
            // If the table already exists, activate the corresponding tab
            $("#tabs").tabs("option", "active", $(`#${tableId}`).index());
        }
    }
